...
#'
#' This function allows to generate p-values under the fitted model through simulations, hence then get the data frame to generate qqplot. 
...
#' @keywords 
#' @export
#' @examples qqplotdata.simu(summarydata, est, c0, qqplotCI.coverage=0.8, qqplot.nsim=10, LDcutoff=0.1, LDwindow=1, filter=F,cores=1,seeds=123)
